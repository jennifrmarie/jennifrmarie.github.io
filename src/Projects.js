    ...
    return (
      <div>
        ...
        <section className="project_1">             
          ...
          <p className="project1_desc"><h3 id="project_header">Reppy, Set, GO!</h3> Full-stack fitness app where fitness junkies can create an
          account and log in using JWT authentication, store their workout on a specific date using a Postgres database, and a React client makes
        ...
        <section className="project_3">
          ...
          <p className="project3_desc"><h3 id="project_header">Holy Macro!</h3>Created an app that allows health buffs to input macronutrients and uses asynchronous programming with promises to send JSON data with recipes based on their search parameters.
